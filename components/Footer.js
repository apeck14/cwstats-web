...
export default function Footer() {
	...
	return (
		<Main>
			<TopDiv>
				<IconButton onClick={discordHandleClick}><DiscordIcon /></IconButton>
				<DonateButton onClick={paypalHandleClick}><HeartIcon />Donate</DonateButton>
			</TopDiv>
			<Hr />
			<BottomDiv>
				<ContentPolicy>This content is not affiliated with, endorsed, sponsored, or specifically approved by Supercell and Supercell is not responsible for it. For more information see Supercell’s Fan Content Policy.</ContentPolicy>
