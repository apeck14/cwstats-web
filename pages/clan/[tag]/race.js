	...
	return (
		<>
			...
			<Main>
				...
				<NavDiv>
					<NavItem onClick={() => router.push(`/clan/${clan.tag.substring(1)}`)}>Home</NavItem>
					<NavItem style={{
								...
								raceClans.map((c, index) => {
									...
									return showMobileView ?
											...
											<MobileLeftDiv style={c.placement === Infinity && !c.crossedFinishLine ? {
												...
												<RaceIcon place={c.placement} isFinished={c.crossedFinishLine} />
												{
													c.placement === Infinity ? null :
														<FameAvg>{getAvgFame(clanInRace, isColosseum, dayOfWeek).toFixed(2)}</FameAvg>
												}
											</MobileLeftDiv>

											<MobileRightDiv>
												<MobileTopDiv style={c.crossedFinishLine ? {
													marginBottom: "0"
												} : null}>
													<MobileTopLeft>
														<MobileTopItem>
															<ClanBadge src={`/assets/badges/${getClanBadgeFileName(c.badgeId, c.trophies)}.png`} height={isMobile ? 24 : 32} width={isMobile ? 18 : 24} />
															<ClanName>
																{c.name}
															</ClanName>
														</MobileTopItem>
													...
													<MobileTopRight>
														<MobileTopItem>
															<RaceImg src="/assets/icons/boat-movement.png" height={18} width={21} />
															{c.boatPoints}
														</MobileTopItem>
														<MobileTopItem>
															<RaceImg src="/assets/icons/fame.png" height={16} width={12} />
															{c.fame}
														</MobileTopItem>
													</MobileTopRight>
												</MobileTopDiv>
												{
													c.crossedFinishLine ? null : <MobileBottomDiv>
														<ProgressBar fame={c.fame} isColosseum={isColosseum} projectedFame={getProjFame(clanInRace, isColosseum, dayOfWeek)} />
													</MobileBottomDiv>
												}
										...
										<ClanDiv key={index} onClick={() => router.push(`/clan/${c.tag.substring(1)}/race`)} style={c.tag === clan.tag ? {
											...
											<LeftClanDiv>
												...
												<LeftInfoDiv>
													<LeftTopDiv>
														...
														<End>
															<RaceImg src="/assets/icons/cw-trophy.png" height={16} width={16} />
											...
											<RightClanDiv>
												<RightInfoDiv>
													<RaceImg src="/assets/icons/boat-movement.png" height={24} width={28} />
													{c.boatPoints}
												</RightInfoDiv>
												<RightInfoDiv>
