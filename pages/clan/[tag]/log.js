...
import { addClan, fetchClan, fetchLog, getUser, saveClan, unsaveClan } from "../../../utils/services"
...
export async function getServerSideProps (context) {
	...
	try {
		const [clanRes, logRes] = await Promise.all([fetchClan(formattedTag), fetchLog(formattedTag)])
		const [clan, log] = await Promise.all([handleSCResponse(clanRes), handleSCResponse(logRes)])
