    ...
    return (
        <>
            ...
            <TopContainer>
                ...
                <TopSubHeader>
                    Detailed war analytics, leaderboards, stats & more!
                </TopSubHeader>
                ...
                <SearchContainer>
                    <SearchDiv>
                        ...
                        <SearchBarContainer>
                            ...
                            <SearchButton
                                onClick={() => router.push("/player/search")}
                            >
                                <SearchIcon />
                            </SearchButton>
                        </SearchBarContainer>
                ...
                <ComingSoonText>
                    * Live search results coming soon
                </ComingSoonText>
            </TopContainer>
            ...
            <SavedContainer>
                <SavedDiv>
                    ...
                    {session ? (
                        <SavedContent>
                            {!savedData || savedData.savedClans.length === 0 ? (
                                <NoSavedText>No clans saved!</NoSavedText>
                            ) : (
                                savedData.savedClans
                                    .slice(0, 5)
                                    .map((c, index) => {
                                        return (
                                            <SavedItem key={index}>
                    ...
                    {savedData && savedData.savedClans.length > 5 ? (
                        <ViewAllSaved href="/me/clans">
                            View All...
                        </ViewAllSaved>
                    ) : null}
                </SavedDiv>
                <BottomSavedDiv>
                    ...
                    {session ? (
                        <SavedContent>
                            {!savedData ||
                            savedData.savedPlayers.length === 0 ? (
                                <NoSavedText>No players saved!</NoSavedText>
                            ) : (
                                savedData.savedPlayers
                                    .slice(0, 5)
                                    .map((p, index) => {
                                        return (
                                            <SavedItem key={index}>
                    ...
                    {savedData && savedData.savedPlayers.length > 5 ? (
                        <ViewAllSaved href="/me/players">
                            View All...
                        </ViewAllSaved>
                    ) : null}
                </BottomSavedDiv>
            ...
            <Leaderboard
                clans={data.dailyLbArr}
                lbLastUpdated={data.lbLastUpdated}
            />

            <BottomContainer>
                <ViewLbButton
                    onClick={() => router.push("/leaderboard/daily/global")}
                >
                    View Leaderboard
                </ViewLbButton>
            </BottomContainer>
